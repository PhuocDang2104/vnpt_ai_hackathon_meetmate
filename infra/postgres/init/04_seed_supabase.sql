...
INSERT INTO meeting_participant (meeting_id, user_id, role) VALUES
    ...
    ('m0000001-0000-0000-0000-000000000001', 'u0000001-0000-0000-0000-000000000001', 'organizer'),
    ('m0000001-0000-0000-0000-000000000001', 'u0000004-0000-0000-0000-000000000004', 'participant'),
    ('m0000001-0000-0000-0000-000000000001', 'u0000005-0000-0000-0000-000000000005', 'participant'),
    ('m0000001-0000-0000-0000-000000000001', 'u0000007-0000-0000-0000-000000000007', 'chair'),
    ('m0000001-0000-0000-0000-000000000001', 'u0000009-0000-0000-0000-000000000009', 'participant'),
    
    -- Weekly Status participants
    ('m0000002-0000-0000-0000-000000000002', 'u0000002-0000-0000-0000-000000000002', 'organizer'),
    ('m0000002-0000-0000-0000-000000000002', 'u0000006-0000-0000-0000-000000000006', 'participant'),
    ('m0000002-0000-0000-0000-000000000002', 'u0000008-0000-0000-0000-000000000008', 'participant'),
    
    -- Risk Review participants
    ('m0000003-0000-0000-0000-000000000003', 'u0000009-0000-0000-0000-000000000009', 'organizer'),
    ('m0000003-0000-0000-0000-000000000003', 'u0000010-0000-0000-0000-000000000010', 'participant'),
    ('m0000003-0000-0000-0000-000000000003', 'u0000001-0000-0000-0000-000000000001', 'participant'),
    ('m0000003-0000-0000-0000-000000000003', 'u0000005-0000-0000-0000-000000000005', 'participant')
...
INSERT INTO action_item (id, meeting_id, owner_id, description, deadline, priority, status, source_text) VALUES
    ...
    ('ai000002-0000-0000-0000-000000000002',
     'm0000001-0000-0000-0000-000000000001',
     'u0000002-0000-0000-0000-000000000002',
    ...
    ('ai000003-0000-0000-0000-000000000003',
     'm0000001-0000-0000-0000-000000000001',
     'u0000005-0000-0000-0000-000000000005',
...
INSERT INTO decision_item (id, meeting_id, description, rationale, confirmed_by_id, status) VALUES
    ('di000001-0000-0000-0000-000000000001',
     'm0000001-0000-0000-0000-000000000001',
    ...
    ('di000002-0000-0000-0000-000000000002',
     'm0000001-0000-0000-0000-000000000001',
...
INSERT INTO risk_item (id, meeting_id, description, severity, mitigation, status, owner_id) VALUES
    ('ri000001-0000-0000-0000-000000000001',
     'm0000001-0000-0000-0000-000000000001',
    ...
    ('ri000002-0000-0000-0000-000000000002',
     'm0000001-0000-0000-0000-000000000001',
    ...
    ('ri000003-0000-0000-0000-000000000003',
     'm0000001-0000-0000-0000-000000000001',
...
INSERT INTO transcript_chunk (id, meeting_id, chunk_index, start_time_seconds, end_time_seconds, speaker_id, text_content) VALUES
    ...
    ('tc000002-0000-0000-0000-000000000002',
     'm0000001-0000-0000-0000-000000000001',
     2, 46, 180,
    ...
    ('tc000003-0000-0000-0000-000000000003',
     'm0000001-0000-0000-0000-000000000001',
     3, 181, 240,
     'u0000007-0000-0000-0000-000000000007',
...
-- Done!
SELECT 'Seed completed! Check your tables.' as status;
