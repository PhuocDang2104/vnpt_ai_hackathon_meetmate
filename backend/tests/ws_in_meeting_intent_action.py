"""
Quick WS test for intent: ACTION_COMMAND.

Usage:
  python vnpt_ai_hackathon/backend/tests/ws_in_meeting_intent_action.py
...
Env (optional):
  ...
  MEETMATE_CHUNK_TEXT="assign task: ..."
"""
...
EXPECTED_INTENT = "ACTION_COMMAND"
DEFAULT_TEXT = "Please assign task: update batch processor to improve throughput."
