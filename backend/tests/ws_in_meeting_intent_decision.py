"""
Quick WS test for intent: DECISION_STATEMENT.

Usage:
  python vnpt_ai_hackathon/backend/tests/ws_in_meeting_intent_decision.py
...
EXPECTED_INTENT = "DECISION_STATEMENT"
DEFAULT_TEXT = "We decide to freeze scope and approve timeline 01/01."
